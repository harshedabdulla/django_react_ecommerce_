...
const DairyPage = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState('dairy products')
  ...
  return (
    <div>
      <HeroBanner title={'Dairy Products'} subheading={'Home - Shop'} />{' '}
      ...
      <div className="mt-4">
        <Row>
          {products
            .filter((item) =>
              selectedCategory === 'dairy products' // Update category name here
                ? true
